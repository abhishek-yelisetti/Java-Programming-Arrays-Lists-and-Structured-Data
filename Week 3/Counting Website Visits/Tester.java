...
public class Tester{
    ...
    public void testIPsMostVisits() {
        ...
        la.readFile("weblog1_log");
        ipCounts = la.countVisitsPerIP();
        ipList = la.iPsMostVisits(ipCounts);
        System.out.println("Ips with most visits = " + ipList);
    }
    ...
    public void testDayWithMostIPVisits() {
        ...
        //Practice Quiz
        la.readFile("weblog1_log");
        ipsPerDay = la.iPsForDays();
        day = la.dayWithMostIPVisits(ipsPerDay);
        System.out.println("Day with most ip visit = " + day); 
    }
    ...
    public void testIPsWithMostVisitsOnDay() {
        ...
        la.readFile("weblog1_log");
        ipsPerDay = la.iPsForDays();
        ipList = la.iPsWithMostVisitsOnDay(ipsPerDay, "Mar 17");
